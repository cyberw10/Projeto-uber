...
public class Corrida { //modificador de acesso
    ...
    public Motorista getMotorista() { // get e set metodos para pegar informção de variveis da classe.
        return motorista;
    }

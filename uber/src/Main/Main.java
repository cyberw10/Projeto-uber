...
public class Main {
    public static void main(String[] args) {
      ...
      System.out.println("Pagamento Feito Da Corrida 1 \n");
      Pagamento pagamento = new Pagamento("Dinheiro",120,corrida1);
      System.out.println(pagamento);
      System.out.println("Corridas Armazenadas \n");
      System.out.println(corridaServico.listarCorridas());

...
public class Main {
    public static void main(String[] args) {
        ...
        Passageiro passageiro1 = new Passageiro("coringa 1", "111111");
        passageiroServico.adicionarPassageiro(passageiro1);
        Passageiro passageiro2 = new Passageiro("coringa 2", "222222");
        passageiroServico.adicionarPassageiro(passageiro2);
        Passageiro passageiro3 = new Passageiro("coringa 3", "333333");
        passageiroServico.adicionarPassageiro(passageiro3);
        Passageiro passageiro4 = new Passageiro("coringa 4", "444444");
...
//        System.out.println(corridaServico.listarCorridasDisponiveis());
        ...
        System.out.println("Bem-vindo ao Uber. Digite o cpf do passageiro que está procurando uma corrida:");
        System.out.println("================================================================================");
        ...
        if (passageiroEncontrado == null) {
            ...
            System.out.println("Agora, escolha umas das corridas disponiveis:\n");
            System.out.println(corridaServico.listarCorridasDisponiveis());
